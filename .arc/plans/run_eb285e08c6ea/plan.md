...
tests:
  - |
    ...
    res = client.post("/api/signup", json={
        "email": "new.user@example.com", "password": "trailrunner8", "display_name": "New U."
    })
  ...
  - |
    ...
    ```python
    res = client.post("/api/signup", json={
        "email": "new2.user@example.com", "password": "trailrunner8", "display_name": "New U."
    })
  ...
  - |
    ...
    client.post("/api/signup", json={
        "email": "dup@example.com", "password": "trailrunner8", "display_name": "Dup A"
    })
    res = client.post("/api/signup", json={
  ...
  - |
    ...
    ```python
    client.post("/api/signup", json={
        "email": "dup2@example.com", "password": "trailrunner8", "display_name": "Dup A"
    })
  ...
  - |
    ...
    ```python
    res = client.post("/api/signup", json={
        "email": "", "password": "trailrunner8", "display_name": "No Email"
    })
  ...
  - |
    ...
    client_a.post("/api/signup", json={
        "email": "alice@example.com", "password": "trailrunner8", "display_name": "Alice"
    })
    client_b.post("/api/signup", json={
        "email": "bob@example.com", "password": "trailrunner8", "display_name": "Bob"
    })
  ...
  - |
    ...
    ```js
    await submitSignupForm({ email: '', password: 'trailrunner8', displayName: 'X' });
